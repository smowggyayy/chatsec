...
# instead of Alpine to avoid DNS resolution issues in production (musl vs glibc).
#
...
# Set the locale (required for Erlang/OTP to function correctly)
...
# advised to add an init process such as tini via `apt-get install tini`
